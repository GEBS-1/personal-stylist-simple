...
- Определи оптимальный размер для каждого предмета на основе роста и веса пользователя
  ...
  "items": [
    {
      ...
      "style": "стиль",
      "fit": "посадка",
      "size": "оптимальный размер (S, M, L, XL или 36, 38, 40, 42 для обуви)"
    },
    {
      "category": "Низ",
      "name": "Название предмета",
    ...
    },
    {
      ...
      "style": "стиль",
      "fit": "размер",
      "size": "оптимальный размер обуви (36, 37, 38, 39, 40, 41, 42)"
    },
    {
      "category": "Аксессуары",
      ...
      "style": "стиль",
      "fit": "размер",
      "size": "оптимальный размер (S, M, L, XL или универсальный)"
    }
  ],
...
• Выбирайте приталенные силуэты, пояса, платья-футляры
• Избегайте мешковатой одежды и прямых силуэтов
• Балансируйте верх и низ - не перегружайте одну часть
• ОБЯЗАТЕЛЬНО: приталенные платья, юбки с поясом, брюки с высокой талией
• Дополнительно: пояса, корсеты, облегающие топы`,
      'inverted-triangle': `
• Балансируйте широкие плечи с объемом внизу
• Выбирайте А-силуэты, расклешенные юбки, объемные низы
• Темные цвета для верха, светлые для низа
• Избегайте объемных плеч и ярких цветов в верхней части
• ОБЯЗАТЕЛЬНО: юбки А-силуэта, расклешенные брюки, объемные низы
• Дополнительно: V-образные вырезы, длинные кардиганы`,
      'triangle': `
• Акцентируйте внимание на верхней части тела
• Выбирайте темные цвета для низа, светлые для верха
• V-образные вырезы, яркие аксессуары на уровне груди
• Избегайте обтягивающих юбок и светлых брюк
• ОБЯЗАТЕЛЬНО: яркие топы, объемные верхние части, V-вырезы
• Дополнительно: яркие аксессуары, объемные рукава`,
      'rectangle': `
...
• ОБЯЗАТЕЛЬНО: пояса, приталенные силуэты, вертикальные линии
• Дополнительно: платья с поясом, брюки с высокой талией`,
      'circle': `
...
• ОБЯЗАТЕЛЬНО: V-вырезы, удлиненные силуэты, вертикальные линии
• Дополнительно: длинные кардиганы, платья-макси`,
      'diamond': `
...
• Избегайте обтягивающей одежды в области талии
• ОБЯЗАТЕЛЬНО: А-силуэты, приталенные силуэты, пояса
• Дополнительно: объемные плечи, расклешенные низы`
    };
  ...
  private getSeasonRecommendations(season: string): string {
    const recommendations = {
      'spring': `
• Весенние цвета: пастельные тона, нежные оттенки, яркие акценты
• Легкие ткани: хлопок, лен, шелк, тонкая шерсть
• Многослойность: кардиганы, жилеты, легкие пальто
• Цветочные принты и нежные узоры
• ОБЯЗАТЕЛЬНО: легкое пальто или куртка для прохладной погоды
• Дополнительно: шарфы, легкие шапки, зонтик`,
      'summer': `
• Летние цвета: яркие, светлые, пастельные тона
• Дышащие ткани: хлопок, лен, вискоза, натуральные материалы
• Минималистичные силуэты, свободные крои
• Защита от солнца: шляпы, солнцезащитные очки
• ОБЯЗАТЕЛЬНО: легкая одежда, открытые варианты
• Дополнительно: летние сумки, украшения, легкие аксессуары`,
      'autumn': `
• Осенние цвета: теплые землистые тона, бордовый, оранжевый, коричневый
• Плотные ткани: шерсть, твид, джинс, плотный хлопок
• Многослойность: пальто, куртки, шарфы, шапки
• Классические принты: клетка, горох, геометрические узоры
• ОБЯЗАТЕЛЬНО: теплая куртка или пальто, утепленная обувь
• Дополнительно: теплые шарфы, перчатки, шапки, зонтик`,
      'winter': `
• Зимние цвета: темные тона с яркими акцентами, металлические оттенки
• Теплые ткани: шерсть, кашемир, мех, плотные материалы
• Многослойность и объем, теплые подкладки
• Контрастные сочетания и металлические акценты
• ОБЯЗАТЕЛЬНО: теплая зимняя куртка или пальто, зимняя обувь
• Дополнительно: теплые шарфы, перчатки, шапки, варежки`
    };
  ...
  private getOccasionRecommendations(occasion: string): string {
    const recommendations = {
      'casual': `
• Комфортная повседневная одежда для ежедневного использования
• Джинсы, футболки, рубашки, кроссовки, кеды
• Практичные материалы: хлопок, джинс, трикотаж
• Удобные силуэты, свободные крои
• Минималистичные аксессуары: сумки, часы, украшения
• ОБЯЗАТЕЛЬНО: удобная обувь, практичная сумка`,
      'business': `
• Классический деловой стиль для офиса и встреч
• Костюмы, блузы, рубашки, туфли на каблуке или лоферы
• Нейтральные цвета: черный, серый, белый, синий, бежевый
• Качественные ткани: шерсть, хлопок, шелк
• Минималистичные украшения и аксессуары
• ОБЯЗАТЕЛЬНО: деловая обувь, портфель или сумка`,
      'evening': `
• Элегантные вечерние наряды для особых случаев
• Платья, костюмы, туфли на каблуке, вечерние сумки
• Яркие цвета, блестящие акценты, элегантные принты
• Дорогие ткани: шелк, атлас, кружево, бархат
• Драгоценные украшения, клатчи, вечерние аксессуары
• ОБЯЗАТЕЛЬНО: элегантная обувь, вечерняя сумка`,
      'sport': `
• Спортивная одежда и обувь для активного отдыха
• Дышащие ткани: полиэстер, спандекс, специальные спортивные материалы
• Удобные силуэты, эластичные крои
• Яркие цвета и функциональные детали
• Спортивные аксессуары: сумки, бутылки, кепки
• ОБЯЗАТЕЛЬНО: спортивная обувь, удобная одежда`
    };
